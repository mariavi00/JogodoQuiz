...
var Q53 = new Questao();
Q53.nivelpergunta = 9;
Q53.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q53.pergunta = "Qual foi a primeira civilização da história?";
Q53.resposta1 = "Egípcia";
Q53.resposta2 = "Mesopotâmica";
Q53.resposta3 = "Grega";
Q53.resposta4 = "Romana";
Q53.resposta5 = "Chinesa";
Q53.respostacorreta = 02;
ListaTodasQuestoes.Add(Q53);

// Nível 10
var Q54 = new Questao();
Q54.nivelpergunta = 10;
Q54.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q54.pergunta = "Quem foi Albert Einstein?";
Q54.resposta1 = "Um físico";
Q54.resposta2 = "Um químico";
Q54.resposta3 = "Um matemático";
Q54.resposta4 = "Um biólogo";
Q54.resposta5 = "Um filósofo";
...
var Q55 = new Questao();
Q55.nivelpergunta = 5;
Q55.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q55.pergunta = "Qual é o nome do famoso detetive criado por Arthur Conan Doyle?";
Q55.resposta1 = "Hercule Poirot";
Q55.resposta2 = "Sherlock Holmes";
Q55.resposta3 = "Miss Marple";
Q55.resposta4 = "Philip Marlowe";
Q55.resposta5 = "Sam Spade";
Q55.respostacorreta = 02;
ListaTodasQuestoes.Add(Q55);

// Nível 6 (continuação)
var Q62 = new Questao();
Q62.nivelpergunta = 6;
Q62.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q62.pergunta = "Qual o autor de 'Cem Anos de Solidão'?";
Q62.resposta1 = "Jorge Luis Borges";
Q62.resposta2 = "Gabriel García Márquez";
Q62.resposta3 = "Mario Vargas Llosa";
Q62.resposta4 = "Julio Cortázar";
Q62.resposta5 = "Pablo Neruda";
Q62.respostacorreta = 02;
ListaTodasQuestoes.Add(Q62);

// Nível 7 (continuação)
var Q63 = new Questao();
Q63.nivelpergunta = 7;
Q63.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q63.pergunta = "Quem foi o primeiro presidente do Brasil?";
Q63.resposta1 = "Getúlio Vargas";
Q63.resposta2 = "Deodoro da Fonseca";
Q63.resposta3 = "Juscelino Kubitschek";
Q63.resposta4 = "Washington Luís";
Q63.resposta5 = "Tancredo Neves";
Q63.respostacorreta = 02;
ListaTodasQuestoes.Add(Q63);

// Nível 8 (continuação)
var Q64 = new Questao();
Q64.nivelpergunta = 8;
Q64.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q64.pergunta = "Qual é a fórmula do gás carbônico?";
Q64.resposta1 = "CO2";
Q64.resposta2 = "C2O";
Q64.resposta3 = "CO";
Q64.resposta4 = "C2O4";
Q64.resposta5 = "C3O";
Q64.respostacorreta = 01;
ListaTodasQuestoes.Add(Q64);

// Nível 9 (continuação)
var Q65 = new Questao();
Q65.nivelpergunta = 9;
Q65.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q65.pergunta = "Qual é o sistema político em que o povo exerce o poder?";
Q65.resposta1 = "Monarquia";
Q65.resposta2 = "Oligarquia";
Q65.resposta3 = "Democracia";
Q65.resposta4 = "Autocracia";
Q65.resposta5 = "Teocracia";
Q65.respostacorreta = 03;
ListaTodasQuestoes.Add(Q65);

// Nível 10 (continuação)
var Q72 = new Questao();
Q72.nivelpergunta = 10;
Q72.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q72.pergunta = "Qual foi a teoria proposta por Darwin?";
Q72.resposta1 = "Teoria da Relatividade";
Q72.resposta2 = "Teoria da Evolução";
Q72.resposta3 = "Teoria da Gravidade";
Q72.resposta4 = "Teoria dos Jogos";
Q72.resposta5 = "Teoria da Fusão";
Q72.respostacorreta = 02;
ListaTodasQuestoes.Add(Q72);

// Nível 5
var Q73 = new Questao();
Q73.nivelpergunta = 5;
Q73.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q73.pergunta = "Qual é o autor de '1984'?";
Q73.resposta1 = "Aldous Huxley";
Q73.resposta2 = "George Orwell";
Q73.resposta3 = "Ray Bradbury";
Q73.resposta4 = "H.G. Wells";
Q73.resposta5 = "Isaac Asimov";
Q73.respostacorreta = 02;
ListaTodasQuestoes.Add(Q73);

var Q74 = new Questao();
Q74.nivelpergunta = 5;
Q74.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q74.pergunta = "Qual é o maior rio do mundo?";
Q74.resposta1 = "Amazonas";
Q74.resposta2 = "Nilo";
Q74.resposta3 = "Yangtze";
Q74.resposta4 = "Mississippi";
Q74.resposta5 = "Ganges";
Q74.respostacorreta = 01;
ListaTodasQuestoes.Add(Q74);

// Nível 6
var Q75 = new Questao();
Q75.nivelpergunta = 6;
Q75.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q75.pergunta = "Qual é o nome do processo de transformar luz solar em energia?";
Q75.resposta1 = "Fotossíntese";
Q75.resposta2 = "Respiração";
Q75.resposta3 = "Evaporação";
Q75.resposta4 = "Condensação";
Q75.resposta5 = "Transpiração";
Q75.respostacorreta = 01;
ListaTodasQuestoes.Add(Q75);

var Q82 = new Questao();
Q82.nivelpergunta = 6;
Q82.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q82.pergunta = "Qual é a capital da Alemanha?";
Q82.resposta1 = "Berlim";
Q82.resposta2 = "Munique";
Q82.resposta3 = "Frankfurt";
Q82.resposta4 = "Hamburgo";
Q82.resposta5 = "Colônia";
Q82.respostacorreta = 01;
ListaTodasQuestoes.Add(Q82);

// Nível 7
var Q83 = new Questao();
Q83.nivelpergunta = 7;
Q83.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q83.pergunta = "Qual é o elemento químico com o símbolo 'Au'?";
Q83.resposta1 = "Prata";
Q83.resposta2 = "Ouro";
Q83.resposta3 = "Alumínio";
Q83.resposta4 = "Cobre";
Q83.resposta5 = "Argônio";
Q83.respostacorreta = 02;
ListaTodasQuestoes.Add(Q83);

var Q84 = new Questao();
Q84.nivelpergunta = 7;
Q84.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q84.pergunta = "Qual é o nome do maior deserto do mundo?";
Q84.resposta1 = "Sahara";
Q84.resposta2 = "Gobi";
Q84.resposta3 = "Antártica";
Q84.resposta4 = "Kalahari";
Q84.resposta5 = "Arábia";
Q84.respostacorreta = 03;
ListaTodasQuestoes.Add(Q84);

// Nível 8
var Q85 = new Questao();
Q85.nivelpergunta = 8;
Q85.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q85.pergunta = "Quem foi o primeiro homem a realizar uma viagem ao espaço?";
Q85.resposta1 = "Yuri Gagarin";
Q85.resposta2 = "Neil Armstrong";
Q85.resposta3 = "Buzz Aldrin";
Q85.resposta4 = "John Glenn";
Q85.resposta5 = "Valentina Tereshkova";
Q85.respostacorreta = 01;
ListaTodasQuestoes.Add(Q85);

var Q92 = new Questao();
Q92.nivelpergunta = 8;
Q92.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q92.pergunta = "Qual é a capital da Itália?";
Q92.resposta1 = "Veneza";
Q92.resposta2 = "Milão";
Q92.resposta3 = "Roma";
...
var Q93 = new Questao();
Q93.nivelpergunta = 9;
Q93.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q93.pergunta = "Qual é a principal religião na Índia?";
Q93.resposta1 = "Cristianismo";
Q93.resposta2 = "Hinduísmo";
Q93.resposta3 = "Islamismo";
Q93.resposta4 = "Budismo";
Q93.resposta5 = "Judaísmo";
Q93.respostacorreta = 02;
ListaTodasQuestoes.Add(Q93);

var Q94 = new Questao();
Q94.nivelpergunta = 9;
Q94.ConfigurarEstruturaDesenho(labelPerg, btnResp01, btnResp02, btnResp03, btnResp04, btnResp05);
Q94.pergunta = "Quem escreveu 'A Divina Comédia'?";
Q94.resposta1 = "Miguel de Cervantes";
Q94.resposta2 = "Dante Alighieri";
Q94.resposta3 = "William Shakespeare";
Q94.resposta4 = "Johann Goethe";
Q94.resposta5 = "Victor Hugo";
Q94.respostacorreta = 02;
